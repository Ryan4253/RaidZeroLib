...
class AsyncVelTBHController : public AsyncWrapper<double, double>, public AsyncVelocityController<double, double> {
    public:
    /**
     ...
     */
    AsyncVelTBHController(const std::shared_ptr<ControllerInput<double>>& iInput,
                          const std::shared_ptr<ControllerOutput<double>>& iOutput, const TimeUtil& iTimeUtil,
                          double iGain, std::unique_ptr<VelMath> iVelMath, double iRatio = 1,
